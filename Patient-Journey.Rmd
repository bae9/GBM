...
# #build boxplot
bwplot((100*brDropoutRate) ~ ordered(Burden,levels=c("Low","Medium","High"))  |  factor(Recurrent,labels=c("Newly Diagnosed","Recurrent")), data=arms, ylab="Dropout %", panel = function(x,y, ...){
