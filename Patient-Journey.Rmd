...
# #build boxplot
bwplot(factor(Recurrent,labels=c("Newly Diagnosed","Recurrent")) ~ (100*brDropoutRate) |  ordered(Burden,levels=c("Low","Medium","High")), data=arms, xlab="Dropout %", horizontal = TRUE)
