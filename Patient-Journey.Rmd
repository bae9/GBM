...
```{r patient-burden, fig.height=5, fig.cap="**TODO:** Caption figure."}
...
#build charts
bxp <- ggplot(data = combo, aes(y=percent, x=arms.Burden, fill=arms.Burden)) + geom_boxplot() + coord_flip() + labs(title="Dropout by Patient Burden", x="Burden Level", y="% of Patient Dropout", fill="Burden") + geom_dotplot(binaxis='y', stackdir='center', dotsize=0.5)
