...
df_arm <- data.frame(arms$Arm, arms$Enrollment, arms$`Universal IV`, arms$Radiation, arms$Surgery, arms$SOC, arms$Randomized, arms$Concomitant, arms$Adjuvant, arms$Recurrent)
...
combo$percent = combo$dropoutsum.Sum / combo$arms.Enrollment
...
fviz_cluster(k2, data=combo, repel=TRUE, labelsize = 5)
...
#build boxplot
boxplot(percent ~ combok$k2.cluster)
